# Overview
This repository contains raw and processed flare observation data that can be used to recreate and validate insights reported on Flaring Monitor white paper.  

The white paper can be access on Flaring Monitor website using this link - https://www.flaringmonitor.org/whitepaper.html
